...
async def order_get_name(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        ...
        parse_mode="HTML",
        reply_markup=ReplyKeyboardMarkup([[SHARE_CONTACT], [BACK_BUTTON], [CANCEL_BUTTON]], resize_keyboard=True),
    )
...
async def order_get_phone(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        "✅ Saqlandi!\n\n📍 <b>3/9: Manzil</b>",
        parse_mode="HTML",
        reply_markup=ReplyKeyboardMarkup([[SHARE_LOCATION], [BACK_BUTTON], [CANCEL_BUTTON]], resize_keyboard=True),
    )
...
async def order_get_location(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if update.message.text == BACK_BUTTON:
        ...
        await update.message.reply_text("📞 <b>2/9: Telefon</b>", parse_mode="HTML", reply_markup=ReplyKeyboardMarkup([[SHARE_CONTACT], [BACK_BUTTON], [CANCEL_BUTTON]], resize_keyboard=True))
        return ORDER_STEP_2_PHONE
...
async def order_get_building(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if text == BACK_BUTTON:
        ...
        await update.message.reply_text("📍 <b>3/9: Manzil</b>", parse_mode="HTML", reply_markup=ReplyKeyboardMarkup([[SHARE_LOCATION], [BACK_BUTTON], [CANCEL_BUTTON]], resize_keyboard=True))
        return ORDER_STEP_3_LOCATION
    if text != SKIP_BUTTON:
...
async def finish_order(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        try:
            ...
            logger.error(f"PDF yuborish xatosi: {e}")
        await update.message.reply_text(f"✅ #{order_id} yakunlandi. {amount} so'm. {warranty}")
    except:
